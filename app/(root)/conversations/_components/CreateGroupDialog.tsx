  ...
  return <Dialog>
        ...
        <DialogContent className="block" >
            ...
            <Form {...form}>
                ...
                name='members' render={() => {
                    return <FormItem>
                        ...
                        <FormControl>
                            <DropdownMenu>
                                <DropdownMenuTrigger
                                asChild disabled={unselectedFriends.length === 0}>
                ...
                />
                {
                    members && members.length ? (<Card className='flex flex-row items-center gap-3 overflow-x-auto w-full h-24 p-2 no-scrollbar'>
                        {friends?.filter(friend => members.includes(friend._id)).map(friend => {
                            ...
                            <div key={friend._id} className='flex flex-col items-center gap-1'>
                                <div className='relative' >
                                    ...
                                    <X className='text-muted-foreground w-4 h-4 absolute -top-1 -right-1 bg-muted rounded-full cursor-pointer'
